...
const Tradereccard = ({trade}) => {
    ...
    return (
        ...
        <h2 style={{ marginTop:10, marginBottom:5, alignSelf:'center', marginLeft:-85 }}>From: {trade.trader.first_name} {trade.trader.last_name}</h2>
         <h3 style={{ alignSelf:'center', fontStyle:'italic', fontWeight: 300, letterSpacing:1.5, marginTop:3, marginBottom:10, marginLeft:-85, fontSize:16 }}>RECEIVED {trade.offered_date}</h3>
