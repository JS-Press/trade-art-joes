               ...
               <div style={{marginTop:200, display:'flex', flexFlow:'row', backgroundColor:'transparent', justifyContent:'space-around'}} >
                    <div style={{ display:'flex', flexFlow:'row', backgroundColor:'transparent', width:'40%', marginLeft:25 }}>
                        <div style={{ display:'flex', flexFlow:'column', backgroundColor:'transparent', width:'60%' }} >
                            ...
                            <h4 style={{marginTop:60, fontWeight:200, marginLeft:0, marginBottom:-30 }} >note from {trade.vendor.first_name}</h4>
                            <div style={{paddingLeft:15, paddingRight:15, paddingTop:5, paddingBottom:5, marginLeft:0, marginTop:40, display:'flex', borderStyle:'solid', borderColor:'white', borderRadius:500, borderWidth:.1, width:170, height:50 }}>
